    ...
    histogram.thresholds = function(_) {
      return arguments.length
        ? ((threshold =
            typeof _ === "function"
              ? _
              : Array.isArray(_) ? constant(slice.call(_)) : constant(_)),
          histogram)
        : threshold;
    };
      ...
      var that = this,
        ...
        mode =
          (exports.event.metaKey ? (type = "overlay") : type) === "selection"
            ? MODE_DRAG
            : exports.event.altKey ? MODE_CENTER : MODE_HANDLE,
    ...
    brush.extent = function(_) {
      return arguments.length
        ? ((extent =
            typeof _ === "function"
              ? _
              : constant$4([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]])),
          brush)
        : extent;
    };
    ...
    return function(lambda, phi) {
      return (
        ...
        [
          lambda > pi$3
            ? lambda - tau$3
            : lambda < -pi$3 ? lambda + tau$3 : lambda,
          phi
        ]
      );
    };
          ...
          : hour$$1(date) < date
            ...
            : day$$1(date) < date
              ...
              : month$$1(date) < date
                ...
                : year$$1(date) < date ? formatMonth : formatYear)(date);
    }
    ...
    stack.order = function(_) {
      return arguments.length
        ? ((order =
            _ == null
              ? none$2
              : typeof _ === "function" ? _ : constant$10(slice$6.call(_))),
          stack)
        : order;
    };
